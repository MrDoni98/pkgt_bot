...
class Bot
{
    ...
    public function __construct($config, $data, $db)
    {
        ...
        $this->user_info = json_decode(file_get_contents("https://api.vk.com/method/users.get?user_ids={$this->user_id}&v=5.0"));
...
//и извлекаем из ответа его имя
                ...
                $status = json_decode(file_get_contents("https://api.vk.com/method/groups.getOnlineStatus?group_id=128463549&access_token={$this->token}&v=5.74"));
                if($status->response->status != "online"){
                    json_decode(file_get_contents("https://api.vk.com/method/groups.enableOnline?group_id=128463549&access_token={$this->token}&v=5.74"));
                }
    ...
    public function getSchedule(string $group, String $date): string {
        ...
        curl_setopt($ch, CURLOPT_PROXY, "77.41.159.2:8080");
